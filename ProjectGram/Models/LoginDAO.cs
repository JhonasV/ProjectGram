...
namespace ProjectGram.Models
{
    public class LoginDAO
    {
        ...
        //        try
        //        {
        //            detalles = db.Usuario.Where(x => x.NickName == NickName).Include(x => x.Foto).Include(x => x.Follows).Include(x => x.FollowedList).FirstOrDefault();
        //        }
        //        catch (Exception e)
        //        {
        ...
        //{
        //    List<User> detalles = new List<User>();
        //    using (GramDbContext db = new GramDbContext())
        //    {

        //        try
        //        {
        //            detalles = db.Usuario.Include(x => x.Foto).ToList();
        //        }
        //        catch (Exception e)
        //        {
